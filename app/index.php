    ...
    <div class="pc-app">
        ...
        <aside class="pc-sidebar" aria-label="Navegación principal">
            ...
            <div class="pc-sidebar-head d-flex align-items-center gap-2">
                <img src="assets/img/logo.svg" alt="Logo de ParkControl" class="pc-logo">
                <div>
            ...
            <nav class="pc-nav">
                <li><a href="index.php" class="pc-nav-link activo" aria-current="page"><i class="bi bi-speedometer2"></i> Inicio</a></li>
                <li><a href="#" class="pc-nav-link deshabilitado" tabindex="-1" aria-disabled="true"><i class="bi bi-car-front"></i> Vehículos</a></li>
                <li><a href="#" class="pc-nav-link deshabilitado" tabindex="-1" aria-disabled="true"><i class="bi bi-grid-3x3-gap"></i> Plazas</a></li>
                <li><a href="#" class="pc-nav-link deshabilitado" tabindex="-1" aria-disabled="true"><i class="bi bi-people"></i> Clientes</a></li>
                <li><a href="#" class="pc-nav-link deshabilitado" tabindex="-1" aria-disabled="true"><i class="bi bi-tags"></i> Tarifas</a></li>
                <li><a href="#" class="pc-nav-link deshabilitado" tabindex="-1" aria-disabled="true"><i class="bi bi-file-earmark-bar-graph"></i> Reportes</a></li>
                <li><a href="#" class="pc-nav-link deshabilitado" tabindex="-1" aria-disabled="true"><i class="bi bi-gear"></i> Configuración</a></li>
            </nav>
            ...
            <div class="pc-sidebar-foot d-flex align-items-center gap-2">
                ...
                <a href="views/login.php" class="ms-auto text-decoration-none opacity-75" title="Cerrar sesión">
        ...
        <div class="pc-app-main">
            ...
            <header class="pc-topbar d-flex align-items-center gap-3">
                ...
                <h1 class="h5 fw-bold mb-0 d-none d-md-block"></h1>
